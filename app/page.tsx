  ...
  return (
    <main className="flex py-10">
      <div className="flex flex-col w-full ">
        <div className="flex flex-col sm:px-20 -mb-56 relative">
          <div className="absolute sm:w-[32vw] sm:ml-24 aspect-square">
            <Image
              as={NextImage}
              width={1500}
              height={500}
          ...
          <div className="flex lg:flex-row flex-col-reverse">
            <div className="2xl:text-4xl lg:text-2xl text-xl text-wh 2xl:ml-32 lg:ml-20 2xl:p-10 p-8 lg:mt-8 h-fit z-0">
